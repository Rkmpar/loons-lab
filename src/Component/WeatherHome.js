...
function WeatherHome() {
  ...
  return (
    <div class="h-[605px] w-full border-4 bg-slate-400 md:box-content bg-bg-weather_block rounded-3xl">
      ...
      <div>
        {typeof weather.main !== "undefined" ? (
          <div className="flex flex-col text-center items-center justify-center pt-4">
            ...
            <div>
              {/* Condition*/}
              <p className="text-4xl text-black-500 font-bold">{weather.weather[0].main}</p>
              <p className="text-4xl text-black-500 font-bold">({weather.weather[0].description})</p>
            </div>
          </div>
        ) : (
          "Invalid Input"
